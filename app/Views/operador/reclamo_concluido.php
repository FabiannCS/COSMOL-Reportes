<?php
/**
 * Vista: Detalle de Reclamo Concluido (Operador)
 * @var string $title
...
<div class="container-fluid p-0">
    ...
    <div class="d-flex flex-column flex-sm-row justify-content-between align-items-start align-items-sm-center gap-3 mb-4">
        <div>
            ...
            <p class="text-muted mb-0">Ficha del Reclamo — Solo lectura</p>
        </div>
        ...
        <div class="col-lg-5">
            ...
            <?php elseif ($estCalc === 'NO PROCEDENTE'): ?>
                <div class="card shadow-sm h-100 border-secondary">
                    <div class="card-header bg-secondary text-white">
                        <h5 class="mb-0"><i class="bi bi-slash-circle me-2"></i>Reclamo No Procedente</h5>
                    </div>
                    <div class="card-body bg-light text-center d-flex flex-column justify-content-center align-items-center p-4">
            ...
            <?php else: ?>
                <div class="card shadow-sm h-100 border-success">
                    ...
                    <div class="card-body bg-light text-center d-flex flex-column justify-content-center align-items-center p-4">
                        ...
                        <h4 class="text-success mb-2">Reclamo ya solucionado</h4>
